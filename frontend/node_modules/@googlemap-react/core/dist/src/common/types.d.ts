...
export declare type GoogleMapLibrary = 'drawing' | 'geometry' | 'places' | 'visualization';
export declare type GoogleMapShape = google.maps.Marker | google.maps.Polygon | google.maps.Polyline | google.maps.Circle | google.maps.Rectangle;
export declare type GoogleMapLayer = google.maps.BicyclingLayer | google.maps.TrafficLayer | google.maps.TransitLayer;
export declare type GoogleMapObjectWithSetMap = GoogleMapShape | GoogleMapLayer | google.maps.GroundOverlay | google.maps.KmlLayer | google.maps.drawing.DrawingManager | google.maps.visualization.HeatmapLayer;
export declare type GoogleMapObjectWithSetOptions = google.maps.Map | GoogleMapShape | google.maps.TrafficLayer | google.maps.StreetViewPanorama | google.maps.KmlLayer | google.maps.drawing.DrawingManager | google.maps.places.Autocomplete;
export declare type GoogleMapObject = GoogleMapObjectWithSetMap | google.maps.StreetViewPanorama | google.maps.places.SearchBox | google.maps.places.Autocomplete;
declare type MapPanes = 'floatPane' | 'mapPane' | 'markerLayer' | 'overlayLayer' | 'overlayMouseTarget';
...
export interface HeatmapLayerOptions extends google.maps.visualization.HeatmapLayerOptions {
    data: WeightedLatLng[];
}
...
declare type ControlPositionName = 'BOTTOM_CENTER' | 'BOTTOM_LEFT' | 'BOTTOM_RIGHT' | 'LEFT_BOTTOM' | 'LEFT_CENTER' | 'LEFT_TOP' | 'RIGHT_BOTTOM' | 'RIGHT_CENTER' | 'RIGHT_TOP' | 'TOP_CENTER' | 'TOP_LEFT' | 'TOP_RIGHT';
export interface StandaloneAutocompleteProps extends React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> {
    id?: string;
...
export interface StandaloneSearchBoxProps extends React.DetailedHTMLProps<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> {
    id?: string;
